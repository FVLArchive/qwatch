...
import { ICache } from '../dataSources/cache/ICache';
...
export interface IActionHandlerPackage {
	...
	source: ISource;
	/** A cache interface that can be used to store and retreive data over the course of 1 conversation. All data will be lost once the conversation is complete. */
	cache: ICache;
