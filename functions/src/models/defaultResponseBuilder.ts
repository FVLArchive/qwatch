...
export class DefaultResponseBuilder implements IResponseBuilder {
    ...
    protected processVoiceMessages(app: DialogflowApp): void {
        ...
        lastSR.textToSpeech = [lastSR.textToSpeech].concat(this.voiceMessages).join(DefaultResponseBuilder.messageDelimiter);
     ...
     * @param richResponse  The richResponse that the simple responses are going to be added to.
     */
    protected respondV1WithOptions(app: DialogflowApp, responseType: ResponseType, richResponse: RichResponse): Promise<void> {
