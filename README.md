...
The following project is a chat bot for **Google Assistant**, designed to allow the user to line-up virtually. There will be two parties, customers and staff. Supposedly, customers and staff should have two separate apps. However, since this is a proof of concept, the two sides were combined into one.
